...
[Last time](HeatEqnReset2.qmd), I solved the 1D bar problem with Robin boundary conditions. And I promised to make this algorithmic using the [FENICS Project code](https://fenicsproject.org/), and I'll get there, but we need to take a bit of an aside. Specifically, it's time to do some physics. Let's look at the heat equation that I presented previously through the eye of a physicist.

...
1. I need to redo all the math every time that I do different shapes/boundary conditions. It would sure be nice if someone else would do that for me.
...
So, not only would I have to do painstaking math, I'd have to do ***slightly different*** painstaking math. So why should I do this on my own.

In my next post, I plan to solve the 1D problems I've solved here using the FENICS code. And generalize to 3D, as well as other shapes.
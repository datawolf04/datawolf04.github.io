...
Rather than plotting mean values for each genre, I thought I'd make a box plot instead of plotting the average rating. So I will tidy up the data.
...
ggplot(data4plot, aes(x=average_rating, y=genre_count, fill=highlight)) +
  ...
  scale_y_discrete() +
  coord_cartesian(clip='off') + catYtheme()
```
